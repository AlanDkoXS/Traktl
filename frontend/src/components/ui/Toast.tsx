...
export const Toast = ({ show, type }: ToastProps) => {
	...
	return (
		...
		>
			...
			<div className="w-full max-w-sm bg-gradient-to-br from-white to-[hsla(var(--color-project-hue),var(--color-project-saturation),96%,1)] dark:from-[rgb(var(--color-bg-inset))] dark:to-[hsla(var(--color-project-hue),calc(var(--color-project-saturation)*0.6),15%,1)] shadow-2xl shadow-black/20 dark:shadow-black/40 rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 border border-gray-200 dark:border-[rgb(var(--color-border-primary))] backdrop-blur-global">
			<div className="p-4">
