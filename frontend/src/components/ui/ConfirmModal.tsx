		...
		<Transition.Root show={isOpen} as={Fragment}>
			...
			>
				<Transition.Child
					...
					leaveTo="opacity-0"
				>
					<div className="fixed inset-0 bg-black/50 overlay-blur-global transition-opacity" />
				</Transition.Child>
				...
				<div className="fixed inset-0 z-10 overflow-y-auto">
					<div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
						...
						>
							<Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-gradient-to-br from-white to-[hsla(var(--color-project-hue),var(--color-project-saturation),96%,0.5)] dark:from-[rgb(var(--color-bg-inset))] dark:to-[hsla(var(--color-project-hue),calc(var(--color-project-saturation)*0.6),15%,0.3)] px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 w-full sm:max-w-lg sm:p-6 border border-gray-200 dark:border-[rgb(var(--color-border-primary))] backdrop-blur-global">
