...
interface ProjectState {
  ...
  createProject: (project: Omit<Project, 'id' | 'user' | 'createdAt' | 'updatedAt'>) => Promise<void>;
  updateProject: (id: string, project: Partial<Omit<Project, 'id' | 'user' | 'createdAt' | 'updatedAt'>>) => Promise<void>;
